...
exports.inspectOpenCodeOutput = inspectOpenCodeOutput;
exports.injectCheckpointNotes = injectCheckpointNotes;
/**
 * Inspect OpenCode stderr JSON for tool events and build a human-readable
 * checkpoint line suitable for Telegram appending.
 */
function inspectOpenCodeOutput(stderr, stdout) {
    const notes = [];
 ...
 */
function injectCheckpointNotes(responseText, notes) {
    if (notes.length === 0)
        return responseText;
...
exports.default = { inspectOpenCodeOutput, injectCheckpointNotes };
//# sourceMappingURL=bridge-checkpoint.js.map